...
- Reference: `tests/Feature/Identity/AuthTest.php` (token-protected profile read, guest 401, logout). The OTP flow, the goals CRUD and the categories CRUD are currently covered by curl smoke suites, not PHPUnit.
